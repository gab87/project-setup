...
/***/ "./src/scripts/config/enter-animation.js":
/*!***********************************************!*\
  !*** ./src/scripts/config/enter-animation.js ***!
  \***********************************************/
/*! no static exports found */
...
var _Transition = __webpack_require__(/*! ./Transition */ "./src/scripts/modules/Transition.js");

var _Transition2 = _interopRequireDefault(_Transition);

var _enterAnimation = __webpack_require__(/*! ../config/enter-animation */ "./src/scripts/config/enter-animation.js");
...
var Layout = function () {
	function Layout() {
		...
		this.transition = new _Transition2.default(_enterAnimation2.default);
		this.gui.add(_enterAnimation2.default, 'duration', 0.4, 3);
	}
...
/***/ "./src/scripts/modules/Transition.js":
/*!*******************************************!*\
  !*** ./src/scripts/modules/Transition.js ***!
  \*******************************************/
/*! no static exports found */
...
var Transition = function () {
	...
	(0, _createClass3.default)(Transition, [{
		...
		value: function animate(type, elIn, elOut, onComplete) {
			...
			tl.set(elIn, this.config[type].in.set).to(elOut, this.config.duration, this.config[type].out.to).to(elIn, this.config.duration, this.config[type].in.to, '-=' + this.config.duration);
		}
	}]);
	return Transition;
}();
...
var View = function () {
	function View(_ref) {
		var _ref$viewClass = _ref.viewClass,
		    viewClass = _ref$viewClass === undefined ? '.section' : _ref$viewClass,
		    _ref$visibleClass = _ref.visibleClass,
		    visibleClass = _ref$visibleClass === undefined ? 'is-visible' : _ref$visibleClass;
